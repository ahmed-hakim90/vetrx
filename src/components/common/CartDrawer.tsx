            ...
            {cart.length === 0 ? (
              <div className="text-center py-16 px-4">
                ...
                <button
                  ...
                  className="min-h-[44px] bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold px-6 py-2.5 rounded-xl transition-all cursor-pointer touch-manipulation active:scale-95"
                >
                  {t('startShopping')}
                </button>
              </div>
                    ...
                    <div className="flex items-center justify-between mt-2 pt-1 border-t border-slate-100">
                      ...
                      <div className="flex items-center border border-slate-200 rounded-lg bg-slate-50 p-0.5">
                        <button
                          ...
                          className="min-w-[36px] min-h-[36px] flex items-center justify-center hover:bg-white rounded-md rtl:rounded-md text-slate-600 cursor-pointer touch-manipulation active:scale-90"
          ...
          {cart.length > 0 && (
            <div className="p-4 border-t border-slate-200 bg-slate-50/80 space-y-3">
              ...
              <button
                ...
                className="w-full min-h-[48px] bg-slate-900 hover:bg-slate-800 active:bg-black text-white py-3.5 px-4 rounded-xl font-bold text-sm flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all cursor-pointer group touch-manipulation active:scale-95"
              >
